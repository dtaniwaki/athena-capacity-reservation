...
from athena_capacity_reservation.monitor import ScaleCheckResult, _MonitorConfig, _run_monitor_loop
...
def test_monitor_loop_runs_check_and_scale_then_stops() -> None:
    ...
    def fake_check_and_scale(c: object, last: float, **kw: object) -> ScaleCheckResult:
        nonlocal tick_count
        tick_count += 1
        stop_event.set()
        return ScaleCheckResult(last, 0, 0, 0)
